...
```text
@authyon/auth   0.2.0-beta.11
@authyon/server 0.2.0-beta.11
```
...
2. Crie a tag anotada `v0.2.0-beta.11` no commit validado.
...
- Próxima correção ou feedback: `0.2.0-beta.12`.
